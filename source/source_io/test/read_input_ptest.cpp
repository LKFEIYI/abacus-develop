...
TEST_F(InputParaTest, ParaRead)
{
    ...
    EXPECT_DOUBLE_EQ(param.inp.sccs_rho_max, 5.0e-3);
    EXPECT_DOUBLE_EQ(param.inp.sccs_gamma, 0.0);
    EXPECT_DOUBLE_EQ(param.inp.sccs_pressure, 0.0);
    EXPECT_DOUBLE_EQ(param.inp.sccs_mixing, 0.5);
    EXPECT_TRUE(param.inp.sccs_mixing_adaptive);
    EXPECT_DOUBLE_EQ(param.inp.sccs_mixing_min, 0.15);
    EXPECT_DOUBLE_EQ(param.inp.sccs_mixing_max, 0.75);
    ...
    EXPECT_FALSE(default_input.sccs_mixing_adaptive);
    EXPECT_DOUBLE_EQ(default_input.sccs_mixing_min, 0.1);
    EXPECT_DOUBLE_EQ(default_input.sccs_mixing_max, 0.8);
    EXPECT_EQ(default_input.sccs_mixing_type, "linear");
    EXPECT_EQ(default_input.sccs_mixing_ndim, 8);
